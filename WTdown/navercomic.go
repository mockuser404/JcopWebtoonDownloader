...
func (nc *NaverComic) Download(start, stop, thread int, folder string) (int, error) {
...
// func (nc *NaverComic) getEpiTitleFromEachPage(page int, c chan error) {
// 	resp, err := http.Get(NAVER_BASE_EPISODES_DATA_URL + nc.TitleId + "&page=" + strconv.Itoa(page))
// 	if err != nil {
// 		c <- err
// 	}
// 	doc, err := goquery.NewDocumentFromReader(resp.Body)
...
// 			// numEpi, err := strconv.Atoi(strnumEpi)
// 			// if err != nil {
// 			// 	log.Println("data-no is not a int")
// 			// }
// 			nc.epis = append(nc.epis,s.Find(".name").Text())
// 		}
// 	})
// 	c <- nil
// }

// func (nc *NaverComic) LoadTitlesURL() error {
...
// 	}
// 	intTotalPages, err := strconv.Atoi(totalPages)
// 	nc.episodeName = make([]string, intTotalPages*30)

// 	c := make(chan error, intTotalPages)
// 	for pageNum := 1; pageNum <= intTotalPages; pageNum++ {
// 		nc.getDataNumFromEachPage(pageNum, c)
// 	}
// 	for pageNum := 1; pageNum <= intTotalPages; pageNum++ {
// 		errormessage := <-c
// 		if errormessage != nil {
...
// func (nc *NaverComic) LoadEpisodesTitle() []string {
// 	return nc.episodeName
// }

// req, err := http.NewRequest("GET", BASE_EPISODES_DATA_URL+nc.titleId, nil)
// if err != nil {
// 	return err, ""
// }
